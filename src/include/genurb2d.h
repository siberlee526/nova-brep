...
public:
    ...
    GE_DLLEXPIMPORT Nova::Boolean  getFitPointAt     (int index, NvGePoint2d& point) const;
    GE_DLLEXPIMPORT Nova::Boolean  getFitTolerance   (NvGeTol& fitTolerance) const;
    GE_DLLEXPIMPORT Nova::Boolean  getFitTangents    (NvGeVector2d& startTangent, 
    ...
    GE_DLLEXPIMPORT Nova::Boolean  getFitData        (NvGePoint2dArray& fitPoints,
	...
	//
    GE_DLLEXPIMPORT Nova::Boolean   setFitPointAt    (int index, const NvGePoint2d& point);
    GE_DLLEXPIMPORT Nova::Boolean   addFitPointAt    (int index, const NvGePoint2d& point);
    ...
    GE_DLLEXPIMPORT Nova::Boolean   setFitTangents   (const NvGeVector2d& startTangent, 
	                        	       const NvGeVector2d& endTangent);
    ...
    GE_DLLEXPIMPORT NvGeNurbCurve2d&  setEvalMode     (Nova::Boolean evalMode=Nova::kFalse );
    ...
    GE_DLLEXPIMPORT Nova::Boolean    addControlPointAt(double newKnot, const NvGePoint2d& point, double weight = 1.0);
