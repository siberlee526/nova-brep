...
public:
    ...
    // Direction tests.
    //
    GE_DLLEXPIMPORT Adesk::Boolean isParallelTo(const NvGeVector3d& vec,
    ...
    GE_DLLEXPIMPORT Adesk::Boolean isCodirectionalTo(const NvGeVector3d& vec,
                                     const NvGeTol& tol = NvGeContext::gTol) const;
    GE_DLLEXPIMPORT Adesk::Boolean isCodirectionalTo(const NvGeVector3d& vec,
                                     const NvGeTol& tol, NvGeError& flag) const;
        // Possible errors: k0Arg1, k0Arg2, kPerpendicularArg1Arg2. 
        // Returns copy of unchanged object on error.
    GE_DLLEXPIMPORT Adesk::Boolean isPerpendicularTo(const NvGeVector3d& vec,
                                     const NvGeTol& tol = NvGeContext::gTol) const;
    GE_DLLEXPIMPORT Adesk::Boolean isPerpendicularTo(const NvGeVector3d& vec,
                                     const NvGeTol& tol, NvGeError& flag) const;
        // Possible errors: k0Arg1, k0Arg2, kPerpendicularArg1Arg2. 
